		      ...
		      <div class="modal-body no-padding">
		        <div class="panel panel-success no-margin">
				  ...
				  <div class="panel-body">
				    <form class="form-horizontal" action="/BankingApp/addRequest" method="POST">
				    	<fieldset>
			    				...
			    				<div class="col-lg-9 form-margin">
      							...
      							<div class="col-lg-9">
       							...
       							<div class="col-lg-10 col-lg-offset-2" style="margin-top:15px;">
			        				...
			        				<button style="float:right;margin-right:15px;" type="submit" onclick="return Validate()" class="btn btn-primary">Submit</button>
      							</div>
				    		</div>
				    	</fieldset>
				    </form>
