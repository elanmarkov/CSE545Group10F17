			...
			<div class="jumbotron">
			  <form action="/employee/internalreg" method="POST">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="firstName" placeholder="Last Name, First Name" required>
				  </div>
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="pincode" placeholder="Zip Code" required>
				  </div>
