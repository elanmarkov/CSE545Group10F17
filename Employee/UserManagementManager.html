	...
	<div class="row">
		<div class="col-lg-14">
			...
			<form action="/BankingApp" method="post">
					...
					<div class="form-group">
					 	<button type="submit" class="btn btn-primary" name="submit">Search Customer</button>
					</div>
			</form>
			</div>
		</div>
			...
			<h3><strong>Pending Authorization</strong></h3>			
				<table class="table table-hover">
					    <thead>
					      ...
					      <tbody>
        					<tr>
	                    		<td>${authorization.internal_userID}</td>
                    			<td>${authorization.internal_userID}</td>
					      ...
					      <tbody>
        					<tr>
								...
								<td>
	                        		<form action = "processauthorization" method = "post">
                                		<input type="hidden" name="transactionID" value="${authorization.auth_id}">
                                		<button type="submit" class="btn btn-xs btn-primary">Revoke</button>
		                            </form>
								</td>
	                		</tr>
